...
namespace RosMessageTypes.Lotusim
{
    ...
    public class LCOEStateMsg : Message
    {
        ...
        public LCOEStateMsg()
        {
            ...
            this.lcoe_aud_mwh = 0.0f;
            this.energy_produced_kwh = 0.0f;
            this.cost_total_aud = 0.0f;
            this.cost_maintenance_aud = 0.0f;
            this.cost_robot_time_aud = 0.0f;
            this.cost_robot_energy_aud = 0.0f;
            this.robot_operation_time_h = 0.0f;
            this.robot_energy_wh = 0.0f;
        }
