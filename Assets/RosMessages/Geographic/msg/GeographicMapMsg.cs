...
namespace RosMessageTypes.Geographic
{
    ...
    public class GeographicMapMsg : Message
    {
        ...
        public GeographicMapMsg(Std.HeaderMsg header, UniqueIdentifier.UUIDMsg id, BoundingBoxMsg bounds, WayPointMsg[] points, MapFeatureMsg[] features, KeyValueMsg[] props)
        {
            this.header = header;
            this.id = id;
            this.bounds = bounds;
